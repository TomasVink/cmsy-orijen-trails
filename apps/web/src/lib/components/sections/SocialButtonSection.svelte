<script lang="ts">
  ...
  const bgSrc = $derived(mediaUrl(bgImage, env.PUBLIC_PAYLOAD_URL))
</script>

<div
  id="community"
  class="relative py-24 px-4 flex items-center justify-center overflow-hidden bg-black"
>
  <!-- Background image -->
  {#if bgSrc}
    <img
  ...
  <div class="relative z-10 text-center text-white max-w-lg">
    ...
    <p class="font-sans text-white/60 text-sm uppercase tracking-widest mb-3">@{block.handle}</p>
